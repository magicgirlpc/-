...
export default function SiteNav() {
  ...
  return (
    <nav className={`nav shell nav-floating${scrolled ? " is-scrolled" : ""}`} aria-label="主导航">
      ...
      <GooeyNav items={[{ label: "关于我", href: "/#about" }, { label: "作品", href: "/photography" }, { label: "联系", href: "/#contact" }]} particleCount={6} particleDistances={[58, 8]} particleR={70} animationTime={520} timeVariance={220} />
